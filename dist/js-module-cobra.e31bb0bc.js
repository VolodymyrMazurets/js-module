...
(function () {
  const cards = document.getElementById("cards"); // const text = "sadklfslkfjlkgjl";
  // const age = 123151355;
  ...
  const arr = ["1", "dasdasd", "test", "dada", "daf", 2, "afaf"]; // console.log(typeof arr);
  ...
  const getData = (() => {
    var _ref = _asyncToGenerator(function* () {
      ...
      cards.innerHTML = parsedRes.map(function ({
        id,
        title
      }) {
        return `<div>
  ...
  getData(); // console.log(async () => await getData());
})();
