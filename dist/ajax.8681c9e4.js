...
const getRandomCoctail = (() => {
  ...
  return function getRandomCoctail() {
    return _ref.apply(this, arguments);
  };
})();

const getSearchedCoctails = (() => {
  var _ref2 = _asyncToGenerator(function* (query) {
    try {
      const res = yield fetch(`${_http.coctailsUrls.search}?s=${query}`);
      const parsedRes = yield res.json();
      return parsedRes;
    } catch (error) {
      _uikit.default.notification({
  ...
  return function getSearchedCoctails(_x) {
...
},{"uikit":"node_modules/uikit/dist/js/uikit.js","./http":"js/http/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
